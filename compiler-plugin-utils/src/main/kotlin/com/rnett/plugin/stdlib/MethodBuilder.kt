...
public abstract class MethodBuilder(protected val builder: IrBuilderWithScope, override val context: IrPluginContext) : HasContext {
...
public abstract class TypedMethodBuilder(
    ...
    public constructor(supertype: ClassRef, builder: IrBuilderWithScope, context: IrPluginContext) : this(supertype(context), builder, context)

    public constructor(supertype: IrClass, builder: IrBuilderWithScope, context: IrPluginContext) : this(supertype.symbol, builder, context)
