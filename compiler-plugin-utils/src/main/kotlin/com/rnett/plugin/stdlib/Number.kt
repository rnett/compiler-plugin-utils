...
public open class NumberBuilders(builder: IrBuilderWithScope, context: IrPluginContext, type: ClassRef = Kotlin.Number) :
...
public class MathableBuilders(protected val mathable: Kotlin.Mathable, builder: IrBuilderWithScope, context: IrPluginContext) :
